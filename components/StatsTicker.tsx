...
export function StatsTicker() {
  ...
  return (
    <div className="relative border-b border-border/40 bg-background/40 backdrop-blur-sm">
      ...
      <div className="relative mx-auto flex max-w-7xl items-center overflow-x-auto px-4 py-2 scrollbar-hide">
        {/* Right-edge scroll hint on mobile */}
        <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-12 bg-gradient-to-l from-background/80 to-transparent sm:hidden" />
