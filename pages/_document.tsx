  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta property="og:image" content="https://www.savepoint.run/SAVEPOINT2-social.png?v=1" />
        ...
        <meta name="twitter:image" content="https://www.savepoint.run/SAVEPOINT2-social.png?v=1" />
      </Head>
